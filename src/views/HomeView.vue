  ...
  <section class="page scroll-page">
    ...
    <article class="reward-card">
      ...
      <div class="food-strip">
        <img src="/assets/reward-left.svg" alt="reward"/>
        <img src="/assets/reward-right.svg" alt="reward"/>
      </div>
      <div class="reward-summary">
        <img src="/assets/reward-bowl.svg" alt="bowl"/>
        <div>
          <h3>main reward</h3>
          <p>expires: 23/8/26</p>
        </div>
    ...
    <article class="promo-card">
      <img src="/assets/promo-ramen.svg" alt="ramen"/>
